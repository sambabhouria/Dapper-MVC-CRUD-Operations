...
/*
 * Class to interact with data base using storeProcedure
 */
namespace DapperMVCCRUD.Models
{
    public static class DapperORM
    {
        // stirng variable to connect to the database
        private static readonly string connectionString = @"Data Source=.;Initial Catalog=DapperDB;Integrated Security=True;";
